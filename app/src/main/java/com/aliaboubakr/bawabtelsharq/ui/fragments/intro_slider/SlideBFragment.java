...
public class SlideBFragment extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View v = inflater.inflate(R.layout.fragment_slide_b,container,false);
        Intent intent = new Intent(getActivity(), MainActivity.class);
        Window window = this.getActivity().getWindow();

        ((IntroActivity)getActivity()).updateStatusBarColor(R.color.status_color2);

        v.findViewById(R.id.skip_b).setOnClickListener(new View.OnClickListener() {
            @Override
