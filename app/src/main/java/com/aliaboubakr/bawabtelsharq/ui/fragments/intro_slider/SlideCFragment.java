...
public class SlideCFragment extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View v = inflater.inflate(R.layout.fragment_slide_c,container,false);
        Intent intent = new Intent(getActivity(), MainActivity.class);
        Window window = this.getActivity().getWindow();

        ((IntroActivity)getActivity()).updateStatusBarColor(R.color.status_color3);

        v.findViewById(R.id.skip_c).setOnClickListener(new View.OnClickListener() {
            @Override
